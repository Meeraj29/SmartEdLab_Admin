                ...
                >
                  <td className="px-8 py-6">
                    <div className="flex flex-col gap-1.5 min-w-[180px]">
                      <span className="text-[15px] font-bold text-slate-900 leading-tight whitespace-nowrap">
                        {log.institute}
                      </span>
                      <span className="inline-flex items-center w-fit rounded-full px-5 py-1 text-[10px] font-black bg-purple-50 text-purple-500 tracking-widest">
                        {log.type}
                      </span>
                    </div>
                  </td>
