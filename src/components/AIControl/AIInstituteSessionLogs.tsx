                ...
                >
                  <td className="px-8 py-6">
                    <div className="flex flex-col gap-1.5 min-w-[180px]">
                      <span className="text-[16px] font-medium font-inter text-black leading-tight whitespace-nowrap">
                        {log.institute}
                      </span>
                      <span className="inline-flex items-center w-fit rounded-full px-5 py-1 text-[12px] font-medium font-inter bg-[#F0DBFF] text-[#2C0051]">
                        {log.type}
                      </span>
                    </div>
                  </td>
                  <td className="px-8 py-6">
                    <div className="flex flex-col">
                      <span className="text-[16px] font-semibold font-inter text-[#0F172A]">
                        {log.student}
                      </span>
...
export default AIInstituteSessionLogs;
