              ...
              <div className="flex items-center justify-between">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full right-0 mt-2 w-44 bg-white rounded-2xl shadow-xl border border-slate-100 p-2 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-all z-20">
                    {["This Week", "Monthly", "Last 6 Months", "Yearly"].map(
                      (option) => (
                        <div
                          key={option}
                      ...
                      >
                        ...
                        <div
                          className={cn(
                            ...
                            dotted
                              ? "border-t-2 border-dashed border-[#6366F1]/60 bg-transparent"
                              : "bg-[#6366F1]"
                          )}
                        />
                      </div>
                ...
                <div className="relative shrink-0 h-[200px] w-[200px]">
                  ...
                  >
                    <circle
                      ...
                      stroke="#22C55E"
                      strokeWidth="20"
                      strokeDasharray={`${(148 / 168) * 376.99} 376.99`}
                      strokeDashoffset="0"
                    />
                    <circle
                      cx="80"
            ...
            <div className="rounded-[22px] bg-white border border-slate-100 shadow-sm overflow-hidden">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left">
                  <thead>
                    <tr className="bg-slate-50/60">
                      {["Session", "Details", "Cancelled By", "Link"].map(
                        (col) => (
                          <th
                            key={col}
                    ...
                    {[
                      {
                        ...
                        date: "Oct 20 - 16:00",
                        by: "Tutor",
                        reason: "Techinical issues",
                      },
                      {
                        id: "#LS-9021",
                        course: "Toefl intensive",
                        date: "Oct 20 - 16:00",
                        by: "Admin",
            ...
            <div className="rounded-[22px] bg-white border border-slate-100 shadow-sm overflow-hidden">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left">
                  <thead>
                    <tr className="bg-slate-50/60">
                      {["Session", "Scheduled", "Delay", "Stu Waiting"].map(
                        (col) => (
                          <th
                            key={col}
                            className="px-6 py-4 text-[16px] font-medium font-inter text-black/80"
              ...
              <div className="flex-1 flex flex-col justify-end mt-4">
                <div className="flex items-end h-[160px] relative gap-0.5">
                  {[
                    ...
                    <div
                      key={data.month}
                      className="flex-1 flex flex-col group h-full justify-end relative"
                    >
                      {/* Background Track */}
              ...
              <div className="flex-1 rounded-[14px] bg-white border border-slate-100 shadow-sm p-8 flex flex-col gap-6">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left">
                    <thead>
                      <tr className="bg-slate-50/60">
                        {["ID / Student", "Issues Type", "Date", "Status"].map(
                          (col) => (
                            <th
                              key={col}
                  ...
                  {[
                    ...
                    >
                      ...
                      <td className="px-8 py-6">
                        <span
                          className={cn(
                            "text-[11px] font-black leading-tight tracking-wide",
                            row.featureColor
                          )}
                        >
                          {row.feature}
              ...
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-white">
                  {[
                    {
                      id: "SES-88219",
                      start: "Feb 12, 10:15 AM",
                      dur: "2h 45m",
                      device: "Laptop",
                      activity: "Class: Calculus 101",
                      activityColor: "text-[#6366F1]",
                      bg: "bg-[#FAFCFF]",
                    },
                    {
                      id: "SES-88102",
                      start: "Feb 11, 04:00 PM",
                      dur: "1h 12m",
                      device: "Mobile App",
                      activity: "Profile Update",
                      activityColor: "text-[#8B5CF6]",
                      bg: "bg-[#F8FAFC]",
                    },
                    {
                      id: "SES-88219",
