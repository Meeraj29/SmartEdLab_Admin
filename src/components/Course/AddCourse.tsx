          ...
          <div className="px-4 md:px-8 lg:px-12 py-5">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <button
                  onClick={handleBack}
                  className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white hover:bg-slate-50 transition-all shadow-sm"
                >
                ...
                <div className="grid grid-cols-1 gap-5">
                  ...
                  <div className="p-6 rounded-[24px] border-2 border-[#2D4A43] bg-[#2D4A43]/5 shadow-sm shadow-[#2D4A43]/10 cursor-pointer transition-all">
                    <div className="flex items-start gap-4 cursor-pointer">
                      <div className="mt-1 h-5 w-5 rounded-full border-2 border-[#2D4A43] flex items-center justify-center">
                  ...
                  <div className="p-6 rounded-[24px] border border-slate-100 bg-slate-50/30 hover:bg-slate-100/50 transition-all">
                    <div className="space-y-6">
                      <div className="flex items-start gap-4 cursor-pointer group">
                        <div className="mt-1 h-5 w-5 rounded-full border-2 border-slate-200 flex items-center justify-center group-hover:border-[#2D4A43] transition-all">
                          {/* Deselected Circle */}
                        </div>
                        <div className="flex flex-col gap-1">
              ...
              <div className="bg-slate-50/50 rounded-[24px] p-8 space-y-8 border border-slate-100/50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="rounded-[20px] border border-transparent bg-white hover:border-slate-200 transition-all shadow-sm">
                    <div className="flex items-start gap-4 p-6 cursor-pointer h-full">
                      <div className="mt-1 h-5 w-5 rounded-full border-2 border-slate-200 flex items-center justify-center">
                        {/* Not selected */}
                      </div>
                      <div className="flex flex-col gap-1.5">
