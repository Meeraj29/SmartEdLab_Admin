          ...
          <div className="bg-white rounded-[24px] p-8 border border-slate-100 shadow-sm space-y-10">
            <div>
              <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2">
                Step: 1{" "}
                <span className="text-slate-800">Institute Identity</span>
              </h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10">
              <div className="space-y-3">
                <label
                  htmlFor="platform"
                  className="text-[15px] font-bold text-slate-800 flex items-center gap-1.5"
                >
                  Institute Name{" "}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-3">
                        <div className="relative flex-1">
                          <span className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-400 font-medium text-sm">
                            https://
                          </span>
                          <input
                            type="text"
              ...
              <div className="bg-[#F8FAFB] rounded-[32px] p-8 border border-white shadow-sm space-y-6">
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between text-[11px] font-bold">
                        ...
                        <span className="bg-indigo-50 text-indigo-500 px-2 py-0.5 rounded-full text-[9px]">
                          Enrollment
                        </span>
                      </div>
                ...
                <div className="bg-purple-50/50 rounded-2xl p-5 border border-purple-100 flex gap-4">
                  ...
                  <div className="space-y-1">
                    <h5 className="text-[13px] font-black text-purple-900">
                      AI Recommendation
                    </h5>
        ...
        <div className="animate-in fade-in slide-in-from-right-4 duration-500 px-4">
          <div className="bg-white rounded-[32px] p-10 border border-slate-100 shadow-sm space-y-8 ">
            <div>
              <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2">
                Step: 3{" "}
                <span className="text-slate-800">Select Subscription Plan</span>
              </h3>
            </div>
              ...
              <div className="p-8 rounded-[32px] border border-slate-100 bg-white space-y-8 transition-all hover:shadow-xl hover:shadow-black/5 cursor-pointer">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li
                      key={i}
                      className="flex items-center gap-3 text-[14px] font-medium text-slate-600"
                    >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 ">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <input
                          type="text"
                          placeholder="500"
                          className="h-14 w-full rounded-2xl bg-[#F8FAFB] border-none px-6 outline-none focus:ring-2 focus:ring-[#2563EB]/10 font-bold text-slate-800"
                        />
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="space-y-1">
                        ...
                        <p className="text-[12px] text-slate-400 font-medium max-w-[400px]">
                    ...
                    >
                      <div className="space-y-1">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-[9px] font-black uppercase tracking-widest text-purple-600 bg-purple-50 px-2 py-0.5 rounded-full border border-purple-100">
                            AI Core
                          </span>
                        </div>
                        <p className="text-[12px] text-slate-400 font-medium max-w-[400px]">
            ...
            <div className="lg:col-span-4 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white p-5 rounded-2xl shadow-sm space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 rounded-full bg-blue-50 text-[9px] font-black uppercase tracking-widest text-[#2563EB]">
                        Premium AI
                      </span>
                      <span className="px-3 py-1 rounded-full bg-purple-50 text-[9px] font-black uppercase tracking-widest text-purple-600">
                        24/7 Support
                      </span>
                    </div>
                  </div>
              ...
              <div className="p-6 rounded-[24px] bg-[#FFF5F5] border border-red-50 flex gap-4">
                ...
                <div className="space-y-1">
                  <h5 className="text-[14px] font-black text-red-900">
                    Pro Tip
                  </h5>
                          ...
                          <div className="p-5 space-y-4">
                            ...
                            <div className="flex flex-wrap gap-2.5">
                              {[
                                ...
                                <span
                                  key={tag}
                                  className="px-4 py-2 rounded-xl bg-[#F1F6FF] text-[12px] font-bold text-slate-600 border border-slate-100"
                                >
                                  {tag}
                                </span>
                              ))}
                      ...
                      <div className="md:col-span-2 p-8 rounded-[24px] bg-[#F1F6FF] border border-blue-50/30">
                        <div className="flex flex-col gap-2">
                          ...
                          <p className="text-[15px] font-black text-slate-800 leading-relaxed">
                            ...
                            via <span className="text-blue-600">Razorpay</span>
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-6 relative z-10">
                  <div className="space-y-4">
                    <div className="flex justify-between items-center text-[15px]">
                      <span className="text-emerald-100/50 font-medium">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-emerald-100/50 font-medium text-[15px]">
                        Setup & Migration Fee
                      </span>
                      <span className="text-emerald-400 font-black tracking-widest text-[11px] uppercase bg-emerald-400/10 px-3 py-1 rounded-full">
                        Waived
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="pt-8 border-t border-white/5 space-y-1.5">
                    <div className="flex justify-between items-end">
                      <div className="space-y-1">
                        <span className="text-[13px] text-emerald-100/40 font-black uppercase tracking-widest">
                          Total Due Now
                        </span>
                  ...
                  <div className="p-6 rounded-[24px] bg-white/[0.03] border border-white/[0.08]">
                    <div className="flex gap-4">
                      ...
                      <p className="text-[12px] leading-relaxed text-emerald-100/60 font-medium">
                        ...
                        <span className="text-white font-black underline decoration-emerald-400/50 underline-offset-4 cursor-pointer hover:text-emerald-400 transition-colors">
